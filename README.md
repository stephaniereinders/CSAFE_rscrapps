...
[![Codecov test
coverage](https://codecov.io/gh/stephaniereinders/rscrapps/branch/master/graph/badge.svg)](https://codecov.io/gh/stephaniereinders/rscrapps?branch=master)
[![Travis build
...
The function getDataForApps will search the Google Play Store for apps
using the input search\_term and scrape data from those apps’ Google
Play Store pages. The function also allows you to specify the number of
apps to scrape using the input num\_apps. To scrape all of the apps
listed in the search results, use num\_apps = “all”.
...
#> 2 Hidden: Steganography & Cryptography      Jamezuki         Tools Everyone
#> 3                              Stegais Roman Cinkais         Tools Everyone
#> 4                        Steganography       Leonid_         Tools Everyone
#> 5                        Steganography Aksel Tórgarð         Tools Everyone
#>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            description
...
#>   rating num_rating      updated size    installs current_version
#> 1    4.1     416949 July 1, 2020 8.9M 50,000,000+    4.2.0.408850
#>   requires_Android content_rating in_app_products offered_by
